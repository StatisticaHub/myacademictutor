...
echo "Installing remaining Statistics Foundations assessments..."

mkdir -p "lib/assessments"
cat > 'lib/assessments/statistics-foundations.ts' <<'__MAT_EOF__'
import type {
  CourseAssessment,
} from "./types";
          ...
          {!result.success ? (
            ...
            <>
              ...
              <p>
                {result.passed
                  ? isFinal
                    ? "Well done. Your final assessment result has been recorded."
...
export default async function AssessmentPage({
  ...
  /*
   * The final assessment unlocks only after all module
   * checkpoints have been passed at least once.
   */
  if (
    assessment.type ===
    "final-assessment"
...
echo ""
echo "Then test:"
echo "  http://localhost:3000/courses/statistics-foundations/assessment/module-02-checkpoint"
